...
> 自动匹配条件：position 包含"销售"、"商务"、"BD"、"专员" 或 roles 包含销售角色
...
| 场景 | 预警提示 |
|------|---------|
| 线索超过3天未跟进 | `⚠️ 线索 {name} 已 {3+} 天未跟进，建议今日联系` |
| 商机阶段超过7天未更新 | `⚠️ 商机 {name} 在 {stage} 阶段停留超过 7 天，建议推动` |
| 今日跟进计划未完成 | `📋 您今日还有 {N} 条跟进计划未完成` |
